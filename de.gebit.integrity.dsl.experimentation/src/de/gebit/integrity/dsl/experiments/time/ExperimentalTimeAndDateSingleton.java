 ...
 */
public final class ExperimentalTimeAndDateSingleton implements TestTimeAdapter {

	/**
	 * The singleton instance.
	 */
	protected static volatile ExperimentalTimeAndDateSingleton instance = new ExperimentalTimeAndDateSingleton();

	public static ExperimentalTimeAndDateSingleton getInstance() {
		return instance;
	}
	 ...
	 */
	protected ExperimentalTimeAndDateSingleton() {
		// empty
	}
	...
	public void setInternalState(long aRealtimeOffset, long aRealtimeDecouplingTime, double aProgressionFactor) {
		...
		System.out.println("==> Time right after setInternalState: " + getDate());
		try {
			Thread.sleep(1000);
		} catch (InterruptedException exc) {
			// ignored
		}
		System.out.println("==> Time after 1 real-time second: " + getDate());
	}
	 ...
	 * {@link ExperimentalTimeAndDateSingleton}.
	 *
