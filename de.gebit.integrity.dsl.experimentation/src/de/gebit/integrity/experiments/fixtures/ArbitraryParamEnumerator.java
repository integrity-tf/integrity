...
public class ArbitraryParamEnumerator implements ArbitraryParameterEnumerator {
	...
	public List<ArbitraryParameterDefinition> defineArbitraryResults(String aFixtureName,
		...
		ArbitraryParameterDefinition tempDefinition = new ArbitraryParameterDefinition(null, null);
		ArbitraryParameterDefinition tempSubDefinition = new ArbitraryParameterDefinition("testresult31",
				"This is a sub parameter.");
		ArbitraryParameterDefinition tempSubSubDefinition = new ArbitraryParameterDefinition("testresult311",
				"This is a sub sub parameter.");
