...
public class DefaultTestRunner implements TestRunner {
	 ...
	 * @param anObject Object to be validated.
	 */
	protected void checkForValidationError(EObject anObject) {
		...
		if (tempConflictOrigin != null) {
				tempResult.append("Validationerror in: " + ModelSourceUtil.getSourceFilePathForINode(tempConflictOrigin) + " in line " 
					+ tempConflictOrigin.getTotalStartLine() + ":");
		} else {
