 ...
 * <ul>
 *   <li>{@link de.integrity.dsl.DecimalValue#getDecimalValue <em>Decimal Value</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.integrity.dsl.DslPackage#getDecimalValue()
 * @model
 * @generated
 */
public interface DecimalValue extends Value
{
   ...
   * @see de.integrity.dsl.DslPackage#getDecimalValue_DecimalValue()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.integrity.dsl.DecimalValue#getDecimalValue <em>Decimal Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
