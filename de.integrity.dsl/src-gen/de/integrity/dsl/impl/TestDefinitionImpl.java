 ...
 * <ul>
 *   <li>{@link de.integrity.dsl.impl.TestDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.integrity.dsl.impl.TestDefinitionImpl#getFixtureMethod <em>Fixture Method</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TestDefinitionImpl extends PackageStatementImpl implements TestDefinition
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.TEST_DEFINITION__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetFixtureMethod(MethodReference newFixtureMethod, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DslPackage.TEST_DEFINITION__FIXTURE_METHOD, oldFixtureMethod, newFixtureMethod);
  ...
  public void setFixtureMethod(MethodReference newFixtureMethod)
  {
    if (newFixtureMethod != fixtureMethod)
    {
      ...
      if (fixtureMethod != null)
        msgs = ((InternalEObject)fixtureMethod).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DslPackage.TEST_DEFINITION__FIXTURE_METHOD, null, msgs);
      if (newFixtureMethod != null)
        msgs = ((InternalEObject)newFixtureMethod).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DslPackage.TEST_DEFINITION__FIXTURE_METHOD, null, msgs);
      msgs = basicSetFixtureMethod(newFixtureMethod, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.TEST_DEFINITION__FIXTURE_METHOD, newFixtureMethod, newFixtureMethod));
  }
