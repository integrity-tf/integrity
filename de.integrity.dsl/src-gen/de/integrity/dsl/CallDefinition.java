 ...
 * <ul>
 *   <li>{@link de.integrity.dsl.CallDefinition#getName <em>Name</em>}</li>
 *   <li>{@link de.integrity.dsl.CallDefinition#getFixtureMethod <em>Fixture Method</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.integrity.dsl.DslPackage#getCallDefinition()
 * @model
 * @generated
 */
public interface CallDefinition extends PackageStatement
{
   ...
   * @see #setName(String)
   * @see de.integrity.dsl.DslPackage#getCallDefinition_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link de.integrity.dsl.CallDefinition#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.integrity.dsl.DslPackage#getCallDefinition_FixtureMethod()
  ...
  /**
   * Sets the value of the '{@link de.integrity.dsl.CallDefinition#getFixtureMethod <em>Fixture Method</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
