 ...
 * <ul>
 *   <li>{@link de.integrity.dsl.TestDefinition#getName <em>Name</em>}</li>
 *   <li>{@link de.integrity.dsl.TestDefinition#getFixtureMethod <em>Fixture Method</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.integrity.dsl.DslPackage#getTestDefinition()
 * @model
 * @generated
 */
public interface TestDefinition extends PackageStatement
{
   ...
   * @see #setName(String)
   * @see de.integrity.dsl.DslPackage#getTestDefinition_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link de.integrity.dsl.TestDefinition#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.integrity.dsl.DslPackage#getTestDefinition_FixtureMethod()
  ...
  /**
   * Sets the value of the '{@link de.integrity.dsl.TestDefinition#getFixtureMethod <em>Fixture Method</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
