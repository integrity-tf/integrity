		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSuiteDefinitionAccess().getGroup_7_1(), "rule__SuiteDefinition__Group_7_1__0");
					...
					put(grammarAccess.getSuiteDefinitionAccess().getGroup_9_2(), "rule__SuiteDefinition__Group_9_2__0");
					...
					put(grammarAccess.getSuiteDefinitionAccess().getSingleRunAssignment_1(), "rule__SuiteDefinition__SingleRunAssignment_1");
					put(grammarAccess.getSuiteDefinitionAccess().getInlinedAssignment_2(), "rule__SuiteDefinition__InlinedAssignment_2");
					put(grammarAccess.getSuiteDefinitionAccess().getNameAssignment_5(), "rule__SuiteDefinition__NameAssignment_5");
					put(grammarAccess.getSuiteDefinitionAccess().getParametersAssignment_7_1_0(), "rule__SuiteDefinition__ParametersAssignment_7_1_0");
					put(grammarAccess.getSuiteDefinitionAccess().getReturnAssignment_8_1_0(), "rule__SuiteDefinition__ReturnAssignment_8_1_0");
					put(grammarAccess.getSuiteDefinitionAccess().getDependenciesAssignment_9_2_0(), "rule__SuiteDefinition__DependenciesAssignment_9_2_0");
					put(grammarAccess.getSuiteDefinitionAccess().getFinalizersAssignment_10_2_0(), "rule__SuiteDefinition__FinalizersAssignment_10_2_0");
					put(grammarAccess.getSuiteDefinitionAccess().getStatementsAssignment_13(), "rule__SuiteDefinition__StatementsAssignment_13");
