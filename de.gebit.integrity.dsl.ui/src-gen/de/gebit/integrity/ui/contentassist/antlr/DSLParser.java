		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSuiteDefinitionAccess().getNameAssignment_4(), "rule__SuiteDefinition__NameAssignment_4");
					put(grammarAccess.getSuiteDefinitionAccess().getParametersAssignment_6_1_0(), "rule__SuiteDefinition__ParametersAssignment_6_1_0");
					put(grammarAccess.getSuiteDefinitionAccess().getReturnAssignment_7_1_0(), "rule__SuiteDefinition__ReturnAssignment_7_1_0");
					put(grammarAccess.getSuiteDefinitionAccess().getDependenciesAssignment_8_2_0(), "rule__SuiteDefinition__DependenciesAssignment_8_2_0");
					put(grammarAccess.getSuiteDefinitionAccess().getFinalizersAssignment_9_2_0(), "rule__SuiteDefinition__FinalizersAssignment_9_2_0");
					put(grammarAccess.getSuiteDefinitionAccess().getStatementsAssignment_12(), "rule__SuiteDefinition__StatementsAssignment_12");
