 ...
 * <ul>
 *   <li>{@link de.integrity.dsl.IntegerValue#getIntegerValue <em>Integer Value</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.integrity.dsl.DslPackage#getIntegerValue()
 * @model
 * @generated
 */
public interface IntegerValue extends Value
{
   ...
   * @see de.integrity.dsl.DslPackage#getIntegerValue_IntegerValue()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.integrity.dsl.IntegerValue#getIntegerValue <em>Integer Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
