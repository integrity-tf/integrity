 ...
 * <ul>
 *   <li>{@link de.integrity.dsl.EnumValue#getEnumValue <em>Enum Value</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.integrity.dsl.DslPackage#getEnumValue()
 * @model
 * @generated
 */
public interface EnumValue extends ValueOrEnumValue
{
   ...
   * @see de.integrity.dsl.DslPackage#getEnumValue_EnumValue()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.integrity.dsl.EnumValue#getEnumValue <em>Enum Value</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
