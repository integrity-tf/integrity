 ...
 * </p>
 * <ul>
 *   <li>{@link de.gebit.integrity.dsl.DateValue#getDateValue <em>Date Value</em>}</li>
 * </ul>
 *
 * @see de.gebit.integrity.dsl.DslPackage#getDateValue()
 * @model
 * @generated
 */
public interface DateValue extends StaticValue
{
   ...
   * @see de.gebit.integrity.dsl.DslPackage#getDateValue_DateValue()
   * @model
   * @generated
   */
  String getDateValue();
  ...
  /**
   * Sets the value of the '{@link de.gebit.integrity.dsl.DateValue#getDateValue <em>Date Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
