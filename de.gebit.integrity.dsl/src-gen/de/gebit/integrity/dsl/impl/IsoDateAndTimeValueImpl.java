...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Iso Date And Time Value</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.gebit.integrity.dsl.impl.IsoDateAndTimeValueImpl#getDateValue <em>Date Value</em>}</li>
 *   <li>{@link de.gebit.integrity.dsl.impl.IsoDateAndTimeValueImpl#getTimeValue <em>Time Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IsoDateAndTimeValueImpl extends DateAndTimeValueImpl implements IsoDateAndTimeValue
{
  /**
   ...
   * @generated
   */
  protected IsoDateAndTimeValueImpl()
  {
    super();
  }
  ...
  {
    return DslPackage.Literals.ISO_DATE_AND_TIME_VALUE;
  }
  ...
  public void setDateValue(String newDateValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.ISO_DATE_AND_TIME_VALUE__DATE_VALUE, oldDateValue, dateValue));
  }
  ...
  public void setTimeValue(String newTimeValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.ISO_DATE_AND_TIME_VALUE__TIME_VALUE, oldTimeValue, timeValue));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DslPackage.ISO_DATE_AND_TIME_VALUE__DATE_VALUE:
        return getDateValue();
      case DslPackage.ISO_DATE_AND_TIME_VALUE__TIME_VALUE:
        return getTimeValue();
    }
