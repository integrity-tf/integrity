...
public class InternalDSLLexer extends Lexer {
    ...
    public final void mRULE_BOOLEAN_TRUE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDSL.g:6438:19: ( 'true' )
            // InternalDSL.g:6438:21: 'true'
            {
            match("true"); 
    ...
    public final void mRULE_BOOLEAN_FALSE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDSL.g:6440:20: ( 'false' )
            // InternalDSL.g:6440:22: 'false'
            {
            match("false"); 
    ...
    public final void mRULE_UPPERCASE_ID() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDSL.g:6442:19: ( 'A' .. 'Z' ( 'A' .. 'Z' | 'a' .. 'z' | '_' | '0' .. '9' )* )
            // InternalDSL.g:6442:21: 'A' .. 'Z' ( 'A' .. 'Z' | 'a' .. 'z' | '_' | '0' .. '9' )*
            {
            matchRange('A','Z'); 
            // InternalDSL.g:6442:30: ( 'A' .. 'Z' | 'a' .. 'z' | '_' | '0' .. '9' )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDSL.g:6444:9: ( ( '^' )? ( 'a' .. 'z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalDSL.g:6444:11: ( '^' )? ( 'a' .. 'z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalDSL.g:6444:11: ( '^' )?
            int alt2=2;
            ...
            // InternalDSL.g:6444:31: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_INTEGER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDSL.g:6446:14: ( ( '-' )? ( '0' .. '9' )+ )
            // InternalDSL.g:6446:16: ( '-' )? ( '0' .. '9' )+
            {
            // InternalDSL.g:6446:16: ( '-' )?
            int alt4=2;
    ...
    public final void mRULE_DECIMAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDSL.g:6448:14: ( ( '-' )? ( '0' .. '9' )+ '.' ( '0' .. '9' )+ )
            // InternalDSL.g:6448:16: ( '-' )? ( '0' .. '9' )+ '.' ( '0' .. '9' )+
            {
            // InternalDSL.g:6448:16: ( '-' )?
            int alt6=2;
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDSL.g:6450:13: ( ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalDSL.g:6450:15: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalDSL.g:6450:15: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt11=2;
            ...
            switch (alt11) {
                case 1 :
                    // InternalDSL.g:6450:16: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalDSL.g:6450:20: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop9:
                    do {
                        int alt9=3;
                        ...
                        switch (alt9) {
                    	case 1 :
                    	    // InternalDSL.g:6450:21: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' )
                    	    {
                    	    match('\\'); 
                    ...
                    break;
                case 2 :
                    // InternalDSL.g:6450:86: '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalDSL.g:6450:91: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop10:
                    do {
                        int alt10=3;
                        ...
                        switch (alt10) {
                    	case 1 :
                    	    // InternalDSL.g:6450:92: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' )
                    	    {
                    	    match('\\'); 
                    	    if ( input.LA(1)=='\"'||input.LA(1)=='\''||input.LA(1)=='\\'||input.LA(1)=='b'||input.LA(1)=='f'||input.LA(1)=='n'||input.LA(1)=='r'||(input.LA(1)>='t' && input.LA(1)<='u') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDSL.g:6452:17: ( '/*' ( '\\n' | '\\r' | '\\t' | ' ' | 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' ) ( options {greedy=false; } : . )* '*/' )
            // InternalDSL.g:6452:19: '/*' ( '\\n' | '\\r' | '\\t' | ' ' | 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' ) ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            if ( (input.LA(1)>='\t' && input.LA(1)<='\n')||input.LA(1)=='\r'||input.LA(1)==' '||(input.LA(1)>='0' && input.LA(1)<='9')||(input.LA(1)>='A' && input.LA(1)<='Z')||input.LA(1)=='_'||(input.LA(1)>='a' && input.LA(1)<='z') ) {
                input.consume();
            ...
            // InternalDSL.g:6452:76: ( options {greedy=false; } : . )*
            loop12:
            do {
                int alt12=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDSL.g:6454:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalDSL.g:6454:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalDSL.g:6454:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop13:
            do {
                int alt13=2;
    ...
    public final void mRULE_SL_VISIBLE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDSL.g:6456:25: ( '-- ' (~ ( ( '\\n' | '\\r' ) ) )* )
            // InternalDSL.g:6456:27: '-- ' (~ ( ( '\\n' | '\\r' ) ) )*
            {
            match("-- "); 

            // InternalDSL.g:6456:33: (~ ( ( '\\n' | '\\r' ) ) )*
            loop16:
            do {
                int alt16=2;
    ...
    public final void mRULE_SL_VISIBLE_TITLE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDSL.g:6458:31: ( '--- ' (~ ( ( '\\n' | '\\r' ) ) )* )
            // InternalDSL.g:6458:33: '--- ' (~ ( ( '\\n' | '\\r' ) ) )*
            {
            match("--- "); 

            // InternalDSL.g:6458:40: (~ ( ( '\\n' | '\\r' ) ) )*
            loop17:
            do {
                int alt17=2;
    ...
    public final void mRULE_ML_VISIBLE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDSL.g:6460:25: ( '/- ' ( options {greedy=false; } : . )* '-/' )
            // InternalDSL.g:6460:27: '/- ' ( options {greedy=false; } : . )* '-/'
            {
            match("/- "); 

            // InternalDSL.g:6460:33: ( options {greedy=false; } : . )*
            loop18:
            do {
                int alt18=2;
    ...
    public final void mRULE_ML_VISIBLE_TITLE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDSL.g:6462:31: ( '/-- ' ( options {greedy=false; } : . )* '--/' )
            // InternalDSL.g:6462:33: '/-- ' ( options {greedy=false; } : . )* '--/'
            {
            match("/-- "); 

            // InternalDSL.g:6462:40: ( options {greedy=false; } : . )*
            loop19:
            do {
                int alt19=2;
    ...
    public final void mRULE_ML_DOC_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDSL.g:6464:21: ( '/**' ( '\\r' )? '\\n' ( options {greedy=false; } : . )* '*/' )
            // InternalDSL.g:6464:23: '/**' ( '\\r' )? '\\n' ( options {greedy=false; } : . )* '*/'
            {
            match("/**"); 

            // InternalDSL.g:6464:29: ( '\\r' )?
            int alt20=2;
            ...
            match('\n'); 
            // InternalDSL.g:6464:40: ( options {greedy=false; } : . )*
            loop21:
            do {
                int alt21=2;
    ...
    public final void mRULE_DIVIDER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDSL.g:6466:14: ( '----' ( '-' )* )
            // InternalDSL.g:6466:16: '----' ( '-' )*
            {
            match("----"); 

            // InternalDSL.g:6466:23: ( '-' )*
            loop22:
            do {
                int alt22=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDSL.g:6468:9: ( ( ' ' | '\\t' )+ )
            // InternalDSL.g:6468:11: ( ' ' | '\\t' )+
            {
            // InternalDSL.g:6468:11: ( ' ' | '\\t' )+
            int cnt23=0;
            loop23:
    ...
    public final void mRULE_NEWLINE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDSL.g:6470:14: ( ( '\\r' | '\\n' )+ )
            // InternalDSL.g:6470:16: ( '\\r' | '\\n' )+
            {
            // InternalDSL.g:6470:16: ( '\\r' | '\\n' )+
            int cnt24=0;
            loop24:
    ...
    public final void mRULE_ISODATE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDSL.g:6472:14: ( '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9' '-' '0' .. '1' '0' .. '9' '-' '0' .. '3' '0' .. '9' )
            // InternalDSL.g:6472:16: '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9' '-' '0' .. '1' '0' .. '9' '-' '0' .. '3' '0' .. '9'
            {
            matchRange('0','9'); 
            matchRange('0','9'); 
            matchRange('0','9'); 
    ...
    public final void mRULE_ISOTIME() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDSL.g:6474:14: ( ( 'T' RULE_TWENTYFOURHRSTIME ( RULE_ISOTIMEZONE )? | RULE_TWENTYFOURHRSTIME RULE_ISOTIMEZONE ) )
            // InternalDSL.g:6474:16: ( 'T' RULE_TWENTYFOURHRSTIME ( RULE_ISOTIMEZONE )? | RULE_TWENTYFOURHRSTIME RULE_ISOTIMEZONE )
            {
            // InternalDSL.g:6474:16: ( 'T' RULE_TWENTYFOURHRSTIME ( RULE_ISOTIMEZONE )? | RULE_TWENTYFOURHRSTIME RULE_ISOTIMEZONE )
            int alt26=2;
            ...
            switch (alt26) {
                case 1 :
                    // InternalDSL.g:6474:17: 'T' RULE_TWENTYFOURHRSTIME ( RULE_ISOTIMEZONE )?
                    {
                    match('T'); 
                    mRULE_TWENTYFOURHRSTIME(); 
                    // InternalDSL.g:6474:44: ( RULE_ISOTIMEZONE )?
                    int alt25=2;
                    int LA25_0 = input.LA(1);

                    if ( (LA25_0=='+'||LA25_0=='-'||LA25_0=='Z') ) {
                        alt25=1;
                    }
                    switch (alt25) {
                        case 1 :
                    ...
                    break;
                case 2 :
                    // InternalDSL.g:6474:62: RULE_TWENTYFOURHRSTIME RULE_ISOTIMEZONE
                    {
                    mRULE_TWENTYFOURHRSTIME(); 
                    mRULE_ISOTIMEZONE(); 
    ...
    public final void mRULE_ISOTIMEZONE() throws RecognitionException {
        try {
            // InternalDSL.g:6476:27: ( ( 'Z' | ( '+' | '-' ) '0' .. '2' '0' .. '9' ( ':' )? '0' .. '5' '0' .. '9' ) )
            // InternalDSL.g:6476:29: ( 'Z' | ( '+' | '-' ) '0' .. '2' '0' .. '9' ( ':' )? '0' .. '5' '0' .. '9' )
            {
            // InternalDSL.g:6476:29: ( 'Z' | ( '+' | '-' ) '0' .. '2' '0' .. '9' ( ':' )? '0' .. '5' '0' .. '9' )
            int alt28=2;
            ...
            switch (alt28) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalDSL.g:6476:34: ( '+' | '-' ) '0' .. '2' '0' .. '9' ( ':' )? '0' .. '5' '0' .. '9'
                    {
                    if ( input.LA(1)=='+'||input.LA(1)=='-' ) {
                        input.consume();
    ...
    public final void mRULE_EURODATE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDSL.g:6478:15: ( '0' .. '3' '0' .. '9' '.' '0' .. '1' '0' .. '9' '.' '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9' )
            // InternalDSL.g:6478:17: '0' .. '3' '0' .. '9' '.' '0' .. '1' '0' .. '9' '.' '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9'
            {
            matchRange('0','3'); 
            matchRange('0','9'); 
            match('.'); 
    ...
    public final void mRULE_USDATE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDSL.g:6480:13: ( '0' .. '1' '0' .. '9' '/' '0' .. '3' '0' .. '9' '/' '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9' )
            // InternalDSL.g:6480:15: '0' .. '1' '0' .. '9' '/' '0' .. '3' '0' .. '9' '/' '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9'
            {
            matchRange('0','1'); 
            matchRange('0','9'); 
            match('/'); 
    ...
    public final void mRULE_TWENTYFOURHRSTIME() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDSL.g:6482:24: ( '0' .. '2' '0' .. '9' ':' '0' .. '5' '0' .. '9' ( ':' '0' .. '6' '0' .. '9' ( '.' '0' .. '9' '0' .. '9' '0' .. '9' )? )? )
            // InternalDSL.g:6482:26: '0' .. '2' '0' .. '9' ':' '0' .. '5' '0' .. '9' ( ':' '0' .. '6' '0' .. '9' ( '.' '0' .. '9' '0' .. '9' '0' .. '9' )? )?
            {
            matchRange('0','2'); 
            matchRange('0','9'); 
            match(':'); 
            matchRange('0','5'); 
            matchRange('0','9'); 
            // InternalDSL.g:6482:66: ( ':' '0' .. '6' '0' .. '9' ( '.' '0' .. '9' '0' .. '9' '0' .. '9' )? )?
            int alt30=2;
            ...
            switch (alt30) {
                case 1 :
                    // InternalDSL.g:6482:67: ':' '0' .. '6' '0' .. '9' ( '.' '0' .. '9' '0' .. '9' '0' .. '9' )?
                    {
                    match(':'); 
                    matchRange('0','6'); 
                    matchRange('0','9'); 
                    // InternalDSL.g:6482:89: ( '.' '0' .. '9' '0' .. '9' '0' .. '9' )?
                    int alt29=2;
                    ...
                    switch (alt29) {
                        case 1 :
                            // InternalDSL.g:6482:90: '.' '0' .. '9' '0' .. '9' '0' .. '9'
                            {
                            match('.'); 
                            matchRange('0','9'); 
                            matchRange('0','9'); 
    ...
    public final void mRULE_TWELVEHRSTIME() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDSL.g:6484:20: ( '0' .. '1' '0' .. '9' ':' '0' .. '5' '0' .. '9' ( ':' '0' .. '6' '0' .. '9' ( '.' '0' .. '9' '0' .. '9' '0' .. '9' )? )? ( 'am' | 'pm' ) )
            // InternalDSL.g:6484:22: '0' .. '1' '0' .. '9' ':' '0' .. '5' '0' .. '9' ( ':' '0' .. '6' '0' .. '9' ( '.' '0' .. '9' '0' .. '9' '0' .. '9' )? )? ( 'am' | 'pm' )
            {
            matchRange('0','1'); 
            matchRange('0','9'); 
            match(':'); 
            matchRange('0','5'); 
            matchRange('0','9'); 
            // InternalDSL.g:6484:62: ( ':' '0' .. '6' '0' .. '9' ( '.' '0' .. '9' '0' .. '9' '0' .. '9' )? )?
            int alt32=2;
            ...
            switch (alt32) {
                case 1 :
                    // InternalDSL.g:6484:63: ':' '0' .. '6' '0' .. '9' ( '.' '0' .. '9' '0' .. '9' '0' .. '9' )?
                    {
                    match(':'); 
                    matchRange('0','6'); 
                    matchRange('0','9'); 
                    // InternalDSL.g:6484:85: ( '.' '0' .. '9' '0' .. '9' '0' .. '9' )?
                    int alt31=2;
                    ...
                    switch (alt31) {
                        case 1 :
                            // InternalDSL.g:6484:86: '.' '0' .. '9' '0' .. '9' '0' .. '9'
                            {
                            match('.'); 
                            matchRange('0','9'); 
                            matchRange('0','9'); 
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDSL.g:6486:16: ( . )
            // InternalDSL.g:6486:18: .
            {
            matchAny(); 
    ...
    static final String DFA34_eotS =
        "\1\uffff\5\62\1\uffff\11\62\1\114\5\uffff\1\125\1\uffff\1\131\7\uffff\1\62\2\uffff\1\145\1\57\1\uffff\1\147\2\57\3\uffff\3\147\1\uffff\2\62\1\uffff\2\62\1\166\3\62\1\uffff\15\62\1\u0088\1\62\2\uffff\1\147\25\uffff\1\62\2\uffff\1\145\1\uffff\1\147\5\uffff\3\147\7\62\1\uffff\17\62\1\uffff\1\62\1\uffff\1\62\6\uffff\1\62\1\145\1\147\4\uffff\3\62\1\u00bb\5\62\1\u00c1\1\62\1\u00c4\1\62\1\u00c6\1\u00c8\5\62\1\u00ce\4\62\2\uffff\1\u00d3\1\uffff\1\147\1\uffff\1\150\1\uffff\3\62\1\uffff\4\62\1\u00df\1\uffff\2\62\1\uffff\1\62\1\uffff\1\62\1\u
\1\4\13\uffff\1\14\5\uffff\1\32\5\uffff\1\5\1\15\1\uffff\1\6\2\uffff\1\12\1\uffff\1\13\5\uffff\1\20\11\uffff\1\26\2\uffff\1\30\1\uffff\1\16\1\23\1\21\6\uffff\1\27\1\uffff\1\40\5\uffff\1\1\1\3\1\uffff\1\11\1\uffff\1\35\4\uffff\1\22\4\uffff\1\25\1\31";
    ...
    static final String[] DFA34_transitionS = {
            ...
            "",
            "",
            "\2\u008c\2\uffff\1\u008c\22\uffff\1\u008c\11\uffff\1\u008d\5\uffff\12\u008c\7\uffff\32\u008c\4\uffff\1\u008c\1\uffff\32\u008c",
            "",
            "\1\u008e\14\uffff\1\u008f",
            "",
            "",
        ...
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            ...
            switch ( s ) {
                    ...
                    case 1 : 
                        ...
                        else if ( (LA34_0=='w') ) {s = 2;}

                        else if ( (LA34_0=='i') ) {s = 3;}

                        else if ( (LA34_0=='f') ) {s = 4;}

                        else if ( (LA34_0=='u') ) {s = 5;}

                        else if ( (LA34_0==':') ) {s = 6;}

                        else if ( (LA34_0=='v') ) {s = 7;}

                        else if ( (LA34_0=='t') ) {s = 8;}

                        else if ( (LA34_0=='c') ) {s = 9;}
                        ...
                        else if ( (LA34_0=='b') ) {s = 13;}

                        else if ( (LA34_0=='o') ) {s = 14;}

                        else if ( (LA34_0=='a') ) {s = 15;}
                        ...
                        else if ( (LA34_0=='n') ) {s = 32;}

                        else if ( (LA34_0=='{') ) {s = 33;}

                        else if ( (LA34_0=='}') ) {s = 34;}

                        else if ( (LA34_0=='T') ) {s = 35;}

                        else if ( (LA34_0=='^') ) {s = 36;}

                        else if ( (LA34_0=='_'||(LA34_0>='d' && LA34_0<='e')||LA34_0=='h'||(LA34_0>='j' && LA34_0<='m')||LA34_0=='q'||(LA34_0>='x' && LA34_0<='z')) ) {s = 37;}

                        else if ( ((LA34_0>='0' && LA34_0<='1')) ) {s = 38;}

                        else if ( (LA34_0=='\"') ) {s = 39;}

                        else if ( (LA34_0=='\'') ) {s = 40;}

                        else if ( (LA34_0=='\t'||LA34_0==' ') ) {s = 41;}

                        else if ( (LA34_0=='\n'||LA34_0=='\r') ) {s = 42;}

                        else if ( ((LA34_0>='A' && LA34_0<='S')||(LA34_0>='U' && LA34_0<='Z')) ) {s = 43;}

                        else if ( (LA34_0=='3') ) {s = 44;}

                        else if ( ((LA34_0>='4' && LA34_0<='9')) ) {s = 45;}

                        else if ( (LA34_0=='2') ) {s = 46;}

                        else if ( ((LA34_0>='\u0000' && LA34_0<='\b')||(LA34_0>='\u000B' && LA34_0<='\f')||(LA34_0>='\u000E' && LA34_0<='\u001F')||LA34_0=='!'||LA34_0=='$'||LA34_0=='&'||LA34_0==';'||(LA34_0>='?' && LA34_0<='@')||LA34_0=='\\'||LA34_0=='`'||(LA34_0>='~' && LA34_0<='\uFFFF')) ) {s = 47;}
