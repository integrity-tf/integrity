...
public class JvmFixtureEvaluation {
	 ...
	 * @param aMethod Method to be checked.
	 * @param someAnnotationTypes Types that should be collected.
	 * @return A list of all annotations of the given types for this method.
	 */
	public List<JvmAnnotationReference> getAllAnnotatedParameter(MethodReference aMethod, List<Class<? extends Annotation>> someAnnotationTypes) {
		if (aMethod == null) {
			return emptyList();
		}
	 ...
	 * @param someAnnotationTypes Annotations that should match.
	 ...
	 * @param anAnnotation Annotation where to search. 
	 * @param aName Name to be searched.
	 ...
	 * @param anAnnotationValue Annotation value to evaluate.
	 * @param anExpectedType Expected type of the value.
