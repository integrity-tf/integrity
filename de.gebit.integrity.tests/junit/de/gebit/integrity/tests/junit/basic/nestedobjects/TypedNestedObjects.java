 ...
 * 
 */
public class TypedNestedObjects extends IntegrityJUnitTest {
	...
	public void test() throws ModelLoadException, IOException, JDOMException {
		Document tempResult = executeIntegritySuite(
				new String[] { "integrity/suites/basic/nestedobjects/typedNestedObjects.integrity" },
				"integrity.basic.nestedobjects.typedNestedObjects", null);
