...
public class SuiteVisibility extends IntegrityJUnitTest {
	...
	public void testFail() throws ModelLoadException, IOException, JDOMException {
		assertExceptionIsThrown(
				...
				ModelRuntimeLinkException.class,
				null,
				Pattern.compile(".*?/suiteVisibilityFail.integrity:19 - Failed to resolve suite referenced in suite call 'suite privateOtherPackage'."));
	}
