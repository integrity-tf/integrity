 ...
 * 
 */
public class BeanBehindConstantTest extends IntegrityJUnitTest {
	...
	public void test() throws ModelLoadException, IOException, JDOMException {
		Document tempResult = executeIntegritySuite(
				new String[] { "integrity/suites/basic/beans/beanBehindConstantTest.integrity" },
				"integrity.basic.beans.beanBehindConstantTest", null);
